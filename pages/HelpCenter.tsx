...
const HelpCenter: React.FC = () => {
  const faqs = [
    {
      ...
      a: 'Vá em &quot;Plantel&quot; &gt; &quot;Nova Ave&quot;, preencha anilha, sexo, status e foto (ou use a imagem padrão). Salve para aparecer no card do plantel.',
    },
    {
      q: 'Como restaurar itens da lixeira?',
      a: 'Toda tela tem aba &quot;Lixeira&quot;. Itens ficam 30 dias lá. Clique em Restaurar para voltar ao ativo ou em Apagar para sempre.',
    },
    {
      q: 'Como gerar remessa de sexagem?',
      a: 'Use &quot;Central Sexagem&quot;: aves sem sexo definido aparecem lá. Selecione, gere a remessa e acompanhe o retorno para marcar o sexo.',
    },
    {
      q: 'Onde vinculo licença e CPF/CNPJ?',
      a: 'Em &quot;Licenças &amp; Docs&quot; os dados vêm de Configurações. Mantenha CPF/CNPJ, SISPASS e datas em Configurações para refletir na licença.',
    },
    {
      q: 'Como registrar tarefas e concluir?',
      a: 'Em &quot;Agenda / Tarefas&quot; crie tarefas (única ou recorrente), conclua para mover ao Histórico e limpe o histórico quando necessário.',
    },
    {
      q: 'Como lançar eventos/torneios?',
      a: 'Em &quot;Torneios / Eventos&quot; cadastre título, data, local e tipo. Use o botão de checklist para preparar o pássaro e acompanhar o progresso.',
    },
    {
      q: 'Como controlar medicamentos e aplicações?',
      a: 'Cadastre o medicamento, aplique escolhendo ave e dosagem, e consulte o histórico na aba Histórico ou no perfil da ave (Histórico de Medicações).',
    },
    {
      q: 'Como lançar receitas e despesas?',
      a: 'Em &quot;Financeiro&quot; clique em &quot;Novo Lançamento&quot;, escolha Receita/Despesa, categoria e subitem. Os lançamentos alimentam os cartões de saldo no dashboard.',
    },
    {
      q: 'Como imprimir cartão de identificação do pássaro?',
      a: 'Este é um recurso exclusivo para usuários com plano Profissional. Abra um pássaro no &quot;Plantel&quot;, clique em &quot;Imprimir Cartão&quot; (botão com ícone de impressora). O cartão inclui: logo do seu criatório, número SISPASS, foto/ilustração da ave, dados completos (anilha, espécie, sexo, data de nascimento, cor/mutação). Configure seu logo e SISPASS em &quot;Configurações&quot; para aparecerem no cartão. Ideal para documentação durante fiscalização do IBAMA.',
    },
  ];
  ...
  const handleAskAI = async () => {
    ...
    try {
      ...
      setAiError(msg || 'Erro ao consultar assistente');
    } finally {
        ...
        <header className="flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
          <div>
            ...
            <p className="text-slate-500 font-medium">
              Tudo o que você precisa para dominar o AviGestão.
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white p-8 rounded-[32px] border border-slate-100 shadow-sm text-center">
            ...
            <p className="text-xs text-slate-400 font-medium mb-4">
              Guia rápido para configurar seu criatório do zero.
            </p>
          ...
          <div className="bg-white p-8 rounded-[32px] border border-slate-100 shadow-sm text-center">
            ...
            <p className="text-xs text-slate-400 font-medium mb-4">
              Troque experiências com outros criadores.
            </p>
            <button className="text-[10px] font-black uppercase text-emerald-500 tracking-widest flex items-center gap-2 mx-auto">
          ...
          <div className="bg-[#0F172A] p-8 rounded-[32px] text-white shadow-xl text-center relative overflow-hidden">
            <Zap
              size={80}
              className="absolute -bottom-4 -right-4 text-amber-500 opacity-20 rotate-12"
              fill="currentColor"
            />
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-white/80 text-xs font-bold">
                        Pergunte sobre criação de aves
                      </p>
                    </div>
                  </div>
                  <button
                ...
                {!aiResponse && !isAILoading && !aiError && (
                  <div className="text-center py-8">
                    ...
                    <p className="text-sm text-slate-500">
                      Faça perguntas sobre manejo, SISPASS, acasalamentos, saúde...
                    </p>
