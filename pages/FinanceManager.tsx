        ...
        {currentList === 'trash' && (
          <div className="bg-rose-50 border-l-4 border-rose-500 p-4 rounded-r-xl">
            ...
            <p className="text-rose-600 text-xs">
              Lançamentos excluídos não contabilizam no saldo enquanto estiverem aqui.
            </p>
                  ...
                  <tr>
                    <td colSpan={5} className="px-8 py-20 text-center text-slate-300">
                      <div className="flex flex-col items-center opacity-30">
                        ...
                        <p className="text-sm font-bold mt-4 uppercase tracking-widest">
                          Nenhum lançamento {currentList === 'active' ? 'encontrado' : 'na lixeira'}
                        </p>
                      </div>
                    </td>
                  </tr>
              ...
              <form onSubmit={handleSave} className="p-10 space-y-6">
                <div className="flex gap-4">
                  <button
                    ...
                    className={`flex-1 py-4 rounded-2xl flex items-center justify-center gap-2 text-xs font-black uppercase transition-all ${
                      newTx.type === 'Receita'
                ...
                <div>
                  ...
                  <input
                    required
                    type="text"
                    placeholder="Ex: Compra de Mistura de Sementes"
                ...
                <div className="flex gap-4 pt-6">
                  <button
                    type="submit"
                    className="w-full py-5 bg-[#0F172A] text-white font-black text-xs uppercase tracking-widest rounded-2xl shadow-xl hover:bg-slate-800 transition-all"
                  >
                    Efetuar Lançamento
                  </button>
                </div>
