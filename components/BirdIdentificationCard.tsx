...
export function BirdIdentificationCard({ bird, settings }: BirdIdentificationCardProps) {
  ...
  const qrCodeUrl = `https://api.qrserver.com/v1/create-qr-code/?size=120x120&data=${encodeURIComponent(
    `https://avigestao.com.br/verify/${bird.id}`,
  )}`;

  // Resolver ancestrais
  const resolveBirdData = (path: string) => {
    if (!bird.manualAncestors)
      return { name: 'Indefinido', ring: '', sex: 'Desconhecido' as const };
  ...
  // deeper ancestor placeholders removed to avoid unused variables
  ...
  // keep setter for path recomputation; path array not used directly
  const [, setPaths] = React.useState<string[]>([]);
  ...
  const recompute = React.useCallback(() => {
    ...
    const built = links.map((l) => buildPath(l.from, l.to, l.color)).filter(Boolean) as Array<{
      d: string;
      color: string;
    }>;
  ...
  return (
    <div className="w-full flex items-center justify-center py-6">
        ...
        >
          ...
          <div className="absolute left-2 right-2 grid grid-cols-3 gap-1" style={{ top: '78px' }}>
            <div className="flex flex-col items-center">
              <div className="text-[5px] font-bold uppercase text-white/60 leading-tight mb-0.5">
                Anilha
              </div>
            ...
            <div className="flex flex-col items-center">
              ...
              <div className="text-[9px] font-black text-white bg-white/10 rounded px-1 py-1 truncate text-center w-full">
                {bird.birthDate
                  ? new Date(bird.birthDate).toLocaleDateString('pt-BR').slice(0, 8)
                  : 'N/A'}
              </div>
            </div>
          </div>
          ...
          <div className="absolute left-2 right-2 grid grid-cols-2 gap-1" style={{ bottom: '6px' }}>
            ...
            <div className="flex flex-col items-center">
              ...
              <div
                className="text-[8px] font-black rounded px-1 py-1 truncate text-center w-full"
                style={{
                  color: accent,
      ...
      >
        ...
        <div
          className="relative h-24 bg-gradient-to-br from-slate-100 to-slate-200 border-b-2 overflow-hidden"
        ...
        <div className="flex-1 p-1 overflow-hidden">
          <h3
            className="text-[6px] font-black uppercase tracking-wider mb-0.5 flex items-center justify-between"
            style={{ color: accent }}
          >
              ...
              <div className="grid grid-cols-[38px_1fr] gap-0.5 items-center border-l border-gray-300 pl-0.5">
                ...
                <div className="flex gap-0.5">
                  <div className="text-center">
                    ...
                    <div className="rounded px-0.5 py-0.5 bg-gray-200 text-gray-600 font-bold text-[4px]">
                      Indef.
                    </div>
                  </div>
                  <div className="text-center">
          ...
          <div className="mt-1 pt-1 border-t border-gray-200 flex items-center gap-2 text-[6px]">
            <div className="flex items-center gap-0.5">
              <div
                ...
                style={{ backgroundColor: '#93c5fd', border: '1px solid #3b82f6' }}
              ></div>
            ...
            <div className="flex items-center gap-0.5">
              <div
                className="w-2 h-2 rounded"
                style={{ backgroundColor: '#f9a8d4', border: '1px solid #ec4899' }}
              ></div>
      ...
      >
        {/* Header Profissional */}
        <div
          className="bg-gradient-to-r px-3 py-2 flex items-center justify-between"
        ...
        >
          <div className="flex items-center gap-2">
            {settings.logoUrl ? (
              ...
              <div
                className="h-7 w-7 rounded-full border-2 flex items-center justify-center bg-yellow-50 text-xs font-bold"
                style={{ borderColor: accent }}
              >
                🦜
              </div>
        ...
        <div className="flex-1 grid grid-cols-3 gap-2 px-2 py-2 overflow-hidden">
          ...
          <div className="flex flex-col items-center justify-center gap-1">
            ...
            >
              <div
                ...
                style={{ color: bird.sex === 'Fêmea' ? '#be185d' : '#1e40af' }}
              >
          ...
          <div className="flex flex-col gap-1 justify-center">
            ...
            >
              <div
                className={`font-bold text-[5.5px] ${
                  father.name === 'Indefinido' ? 'text-gray-400 italic' : 'text-blue-900'
                }`}
              >
            ...
            >
              <div
                className={`font-bold text-[5.5px] ${
                  mother.name === 'Indefinido' ? 'text-gray-400 italic' : 'text-pink-900'
                }`}
              >
          ...
          <div className="flex flex-col gap-1 justify-center">
            ...
            <div className="flex gap-0.5 flex-1 min-h-[22px]">
              ...
              >
                <div
                  className={`font-bold text-[4px] ${
                    ff.name === 'Indefinido' ? 'text-gray-400 italic' : 'text-blue-800'
                  }`}
                >
              ...
              >
                <div
                  className={`font-bold text-[4px] ${
                    fm.name === 'Indefinido' ? 'text-gray-400 italic' : 'text-pink-800'
                  }`}
                >
            ...
            <div className="flex gap-0.5 flex-1 min-h-[22px]">
              ...
              >
                <div
                  className={`font-bold text-[4px] ${
                    mf.name === 'Indefinido' ? 'text-gray-400 italic' : 'text-blue-800'
                  }`}
                >
              ...
              >
                <div
                  className={`font-bold text-[4px] ${
                    mm.name === 'Indefinido' ? 'text-gray-400 italic' : 'text-pink-800'
                  }`}
                >
        ...
        {/* Legenda Footer */}
        <div
          className="px-2 py-1 border-t text-[5px] flex items-center justify-center gap-3"
          style={{ borderColor: accent }}
        >
